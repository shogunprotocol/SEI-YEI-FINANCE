...
export default buildModule("VaultSystemModule", (m) => {
  ...
  const yeiFinanceProtocol = m.contract(
    "YeiFinanceProtocol",
    [underlyingToken, rewardToken],
    {
      id: "YeiFinanceProtocol",
    }
  );
  ...
  const vault = m.contract(
    "Vault",
    [underlyingToken, "DeFi Vault Token", "vDEFI", manager, agent],
    {
      id: "Vault",
    }
  );
  ...
  // Transfer reward tokens to YEI FINANCE protocol
  m.call(rewardToken, "transfer", [yeiFinanceProtocol, parseEther("10000")], {
